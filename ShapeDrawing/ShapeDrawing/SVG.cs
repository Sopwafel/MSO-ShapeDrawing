...
namespace ShapeDrawing
{
    ...
    class SVG : Exporter
    {
        ...
        public SVG()
        {
            ExportString = new StringBuilder("<?xml version=\"1.0\" standalone=\"no\"?> <!DOCTYPE svg PUBLIC \"-//W3C//DTD SVG 1.1//EN\" \"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd\"> <svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\"> ");
        }
        /// <summary>
        ...
        public override void DrawEllipse(Pen pen, int x, int y, int size, int size2)
        {
            ...
            ExportString.Append(svg);
        }

        // Draws a Line to the SVG string
        public override void DrawLine(Pen pen, int x, int y, int x2, int y2)
        {
            ExportString.Append(String.Format("<line x1=\"{0}\" y1=\"{1}\" x2=\"{2}\" y2=\"{3}\" style=\"fill:none; stroke:black; stroke - width:1\" />", x, y, x2, y2));
        }
